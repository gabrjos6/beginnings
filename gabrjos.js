...
if(t > 99 && t < 201) { //Ya screwed up here. There is no specification for what happens when the input IS ACTUALLY 100. Change the parameters to t > 99, so it INCLUDES 100.
  alert("You got an A+!");
}
if(t > 92 && t < 100) {
